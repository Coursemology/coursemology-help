...
![3a-1]({{ site.url }}/{{ site.baseurl }}/images/3A-1.gif)
...
![3A-3]({{ site.url }}/{{ site.baseurl }}/images/3A-3.gif)

[previous]({{ site.url }}/{{ site.baseurl }}/coursemology/settings)

[next]({{ site.url }}/{{ site.baseurl }}/course/add-manage-users)