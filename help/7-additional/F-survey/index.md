...
You can create surveys to get feedback from your students!
  1. Click on **Surveys** on the side bar.
  2. Click on **New Survey** the top right.
  3. Fill in the details and select the settings accordingly.
  4. Click **Submit**.

![7F-1]({{ site.baseurl }}/images/7F-1.png) 

It should then bring you to this page:

![7F-2]({{ site.baseurl }}/images/7F-2.png)

You can create **Sections** to modularize your questions:

![7F-3]({{ site.baseurl }}/images/7F-3.png)
...
![7F-4]({{ site.baseurl }}/images/7F-4.png)

Once you're done creating your survey, remember to **publish** it!

Additionally, you can view the statistics for the survey:
...
![7F-5]({{ site.baseurl }}/images/7F-5.gif)
